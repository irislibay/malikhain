        ...
        <div class="d-flex">
            <div class="col-4 box1">
                <div class="card-img">
                    <div class="content">
                        <div class="front">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/b/b0/Jose_rizal_01.jpg"/>
                        </div>
                        <div class="back">
                            Achievements Here!
                        </div>
                    ...
                    <div class="col-12 overbox">
                        <div class="box3">
                            <div class="card-scroll">
                                <h2>José Protasio Rizal Mercado y Alonso Realonda</h2>
                                <p>Alma mater: 	Ateneo Municipal de Manila (BA), Universidad Central de Madrid (MD)<br>
                                    Birthdate: June 19, 1861<br>
                                    Deathdate: 	December 30, 1896<br>
                                    Age: 53<br>
                                    AKA: Pepe<br>
