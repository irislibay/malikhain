...
<div class="text-white mb-5">
	<div class="text-center my-5" data-aos="fade-up" data-aos-duration="2000">
		<p class="display-3 drop-shadow font-weight-bold" style="font-family: 'Megrim', cursive;">Poem Style Fusion</p>
		<p class="h2" style="font-family: 'Major Mono Display', cursive">Style-content-fused works using artificial intelligence</p>
	</div>
    <div class="">
                            ...
                            <div class="form-group">
                                ...
                                <div class="card-footer">
                                    <div class="form-group text-center">
                                        <button type="submit" class="btn btn-success btn-sm mr-2"> Fuse File </button>
                    ...
                    <form>
                        <div class="card col-12 mb-5 bg-transparent border border-white">
                            <div class="card-body text-white">
                                ...
                                <div class="row mt-3">
                                    <div class="col"></div>
                                    <button class="col btn btn-success btn-sm mr-2">Profile</button>
                                    <button class="col btn btn-success btn-sm">Download</button>
                                </div>
                            </div>
                        </div>
                    </form>
