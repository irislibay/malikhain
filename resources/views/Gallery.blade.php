        ...
        <div id="header" class="container">
            ...
            <div id="menu">
                <ul>
                    ...
                    <li class="current_page_item"><a href="/Gallery" accesskey="3" title="">Gallery</a></li>
	...
	<div id="featured-wrapper">
		<div id="featured" class="extra2 margin-btm container">
			<div class="main-title">
				<h2>Gallery</h2>
				<span class="byline">Artworks fused with Classic Filipino artists using A.I.</span> </div>
        </div>
	</div>
</div>
